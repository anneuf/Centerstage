...
<title>Centerstage Edit Announcement</title>
...
if ($newannounce=1) {
  ...
  $sql3 = "INSERT INTO song (idsong,name,artist,lyrics_pages,durtion,pitch,tempo) values (" . $idsong . ",'Ansage" . $anindex . "','',1,'00:04:00',E,0)";
